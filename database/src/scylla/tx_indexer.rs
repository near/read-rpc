// ScyllaDB manager for transaction, receipt, and outcome storage
// All ScyllaDB-specific logic will be implemented here

use crate::base::tx_indexer::TxIndexerDbManager;
use anyhow::Result;
...
#[async_trait]
impl TxIndexerDbManager for ScyllaDBManager {
    async fn create_tx_tables(&self) -> Result<()> {
        Self::create_keyspace(&self.scylla_session).await?;
