...
pub trait StateIndexerDbManager {
    ...
    async fn save_state_changes_data(
        ...
        self.update_state_changes_data(shard_id, state_changes.clone(), block_height)
            .await?;
        self.insert_state_changes_data(shard_id, state_changes, block_height)
            .await?;
        Ok(())
    }
    ...
    async fn save_state_changes_access_key(
        ...
        self.update_state_changes_access_key(shard_id, state_changes.clone(), block_height)
            .await?;
        self.insert_state_changes_access_key(shard_id, state_changes, block_height)
            .await?;
        Ok(())
    }
    ...
    async fn save_state_changes_contract(
        ...
        self.update_state_changes_contract(shard_id, state_changes.clone(), block_height)
            .await?;
        self.insert_state_changes_contract(shard_id, state_changes, block_height)
            .await?;
        Ok(())
    }
    ...
    async fn save_state_changes_account(
        ...
        self.update_state_changes_account(shard_id, state_changes.clone(), block_height)
            .await?;
        self.insert_state_changes_account(shard_id, state_changes, block_height)
            .await?;
        Ok(())
    }
